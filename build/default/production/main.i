...
# 18 "main.s" 2
 ...
 BCF ((PIR1) and 07Fh), 0 ; Limpiamos bandera de interrupción
 endm
 ...
 BTFSC ((INTCON) and 07Fh), 2 ; Verificamos si hay interrupción del TIMER0
 CALL INT_TMR0 ; Subrutina INT_TMR0

 BTFSC ((PIR1) and 07Fh), 0 ; Verificamos si hay interrupción del TIMER1
 CALL INT_TMR1 ; Subrutina INT_TMR1

 BTFSC ((PIR1) and 07Fh), 1 ; Verificamos si hay interrupción del TIMER2
